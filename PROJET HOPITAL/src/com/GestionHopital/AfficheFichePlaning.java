...
public class AfficheFichePlaning extends JFrame {
	//String[]title;
	JTable tableau;
	//Object [][] data;
	...
	public AfficheFichePlaning(){
		this.setTitle("PLANING DE TOUS LES MEDECINS");
	...
	private void initComportment() {
		...
		try{
			...
			ResultSet result = state.executeQuery("SELECT * FROM planingmedecin");
