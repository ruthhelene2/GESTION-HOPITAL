...
public class ConsulterPharmacie extends JFrame{
	//String[]title;
			JTable tableau;
			//Object [][] data;
			...
			public ConsulterPharmacie(){
				this.setTitle("LISTE DES PHARMACIES");
			...
			private void initComportment() {
				...
				try{
					...
					ResultSet result = state.executeQuery("SELECT * FROM pharmacie");
				...
				lIcon2 = new JLabel(new ImageIcon("C:/Users/RUTH/Pictures/Saved Pictures/img38.PNG"));
