...
public class FicheHospitalisation extends JFrame {
	//String[]title;
		JTable tableau;
		//Object [][] data;
		...
		public FicheHospitalisation(){
			this.setTitle("FICHE D'HOSPITALISATION DE TOUT LES PATIENTS");
		...
		private void initComportment() {
			...
			try{
				...
				ResultSet result = state.executeQuery("SELECT * FROM hospitalisation");
			...
			//lIcon = new JLabel(new ImageIcon("C:/Users/RUTH/Pictures/Saved Pictures/img29.PNG"));
			lIcon2 = new JLabel(new ImageIcon("C:/Users/RUTH/Pictures/Saved Pictures/img36.PNG"));
			lIcon3 = new JLabel(new ImageIcon("C:/Users/RUTH/Pictures/Saved Pictures/img2.PNG"));
			//panIcon.add(lIcon, BorderLayout.WEST);
			panIcon.add(bDispose, BorderLayout.EAST);
			panIcon.add(lIcon2, BorderLayout.CENTER);
			panIcon.add(lIcon3, BorderLayout.WEST);
