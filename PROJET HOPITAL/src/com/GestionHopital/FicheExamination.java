...
public class FicheExamination extends JFrame{
	//String[]title;
		JTable tableau;
		//Object [][] data;
		...
		public FicheExamination(){
			this.setTitle("FICHE RENDEZ-VOUS DE TOUT LES PATIENTS");
		...
		private void initComportment() {
			...
			try{
				...
				ResultSet result = state.executeQuery("SELECT * FROM examination");
