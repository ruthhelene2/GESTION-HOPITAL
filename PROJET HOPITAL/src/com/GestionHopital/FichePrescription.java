...
public class FichePrescription extends JFrame{
	//String[]title;
	JTable tableau;
	//Object [][] data;
	...
	public FichePrescription(){
		this.setTitle("FICHE PRESCRIPTION DE TOUT LES MEDECINS");
	...
	private void initComportment() {
		...
		Font pol = new Font("Tahoma", Font.BOLD, 16);
		...
		//lIcon2 = new JLabel(new ImageIcon("C:/Users/RUTH/Pictures/Saved Pictures/img28.PNG"));
		lIcon3 = new JLabel(new ImageIcon("C:/Users/RUTH/Pictures/Saved Pictures/img30.PNG"));
